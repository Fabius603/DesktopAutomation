...
public partial class StaticRoiEditor : UserControl
{
    public StaticRoiEditor() => InitializeComponent();

    public static readonly DependencyProperty IsRoiEnabledProperty = DependencyProperty.Register(
        nameof(IsRoiEnabled), typeof(bool), typeof(StaticRoiEditor), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));
